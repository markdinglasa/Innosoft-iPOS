...
IIF(([TrnCollection].[IsCancelled] = 0 OR [TrnCollection].[IsCancelled] IS NULL) AND (TrnSalesLine.DiscountId <> 3 AND TrnSalesLine.DiscountId <> 4), FORMAT(([TotalDiscount].[TotalDiscountAmount]), '0.00000'),'0.00000') AS [DiscountAmount], 
IIf(
